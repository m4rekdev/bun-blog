...
6. (Optional, as bun-blog parses the posts automatically when starting and then every 5 minutes) To manually parse posts, so the HTML files for them are generated in the `public/posts` folder.
